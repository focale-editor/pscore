# Contributing to PsCore

Thanks for helping improve PsCore. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/pscore/issues) before opening a new one.
...
PsCore follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/pscore.git
cd pscore
dart pub get
```
